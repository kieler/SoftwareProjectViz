...
public class SPVizPackageImpl extends EPackageImpl implements SPVizPackage
{
   ...
   * @generated
   */
  private EClass shownCategoryConnectionEClass = null;
   ...
   */
  @Override
  public EReference getView_ShownCategoryConnections()
  {
   ...
   */
  @Override
  public EClass getShownCategoryConnection()
  {
    return shownCategoryConnectionEClass;
  }
   ...
   */
  @Override
  public EReference getShownCategoryConnection_Connection()
  {
    return (EReference)shownCategoryConnectionEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getShownCategoryConnection_SourceChain()
  {
    return (EReference)shownCategoryConnectionEClass.getEStructuralFeatures().get(1);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(viewEClass, VIEW__SHOWN_CATEGORY_CONNECTIONS);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getView_ShownCategoryConnections(), this.getShownCategoryConnection(), null, "shownCategoryConnections", null, 0, -1, View.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
